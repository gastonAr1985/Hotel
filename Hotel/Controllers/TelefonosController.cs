...
namespace Hotel.Controllers
{
    public class TelefonosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Numero,EmpleadoId")] Telefono telefono)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Numero,EmpleadoId")] Telefono telefono)
        {
            if (id != telefono.Id)
            {
                return NotFound();
